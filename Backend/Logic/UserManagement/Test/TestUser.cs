...
namespace WhosThat.Test
{
	static class TestUser
	{
		public static Person CreateTestPerson(string initials)
		{
			/*switch (initials)
			{
				case "BC":
					return new Person("Benaffleck Cantact", lel, "cucumbers, pickles")
					{
						Images =
						{
							new Bitmap(@"UserManagement\Test\balthazar_cottonsnack.jpg"),
							new Bitmap(@"UserManagement\Test\bendfit_cumberland.jpg"),
							new Bitmap(@"UserManagement\Test\bendynoodle_crumplybuns.jpg"),
							new Bitmap(@"UserManagement\Test\buttercup_cumberbotch.jpg"),
							new Bitmap(@"UserManagement\Test\cucumber_1.jpg")
						},
						id = 111111
					};
				case "DJ":
					return new Person("Dwayne Johnson", "looks like a rock", "rocks")
					{
						Images =
						{
							new Bitmap(@"UserManagement\Test\dj1.jpg"),
							new Bitmap(@"UserManagement\Test\dj2.jpg"),
							new Bitmap(@"UserManagement\Test\dj3.jpg"),
							new Bitmap(@"UserManagement\Test\dj4.jpg"),
							new Bitmap(@"UserManagement\Test\dj5.jpg")
						},
						id = 222222
					};
				case "DT":
					return new Person("Donald J. Trump", "looks like an orange", "definately not china nor mexico")
					{
						Images =
						{
							new Bitmap(@"UserManagement\Test\dt1.jpg"),
							new Bitmap(@"UserManagement\Test\dt2.jpg"),
							new Bitmap(@"UserManagement\Test\dt3.jpg"),
							new Bitmap(@"UserManagement\Test\dt4.jpg"),
							new Bitmap(@"UserManagement\Test\dt5.jpg")
						},
						id = 333333
					};
			}*/
			return new Person("BlankName", "BlankBio", "BlankLikes")
			{
				Id = 999999
			};
		}

		private static string lel =
